...
public class Task5Test {
    ...
    @DisplayName("Проверка функции для проверки на палиндром")
    public void testIsPalindrome(String input, boolean expected) {
        assertThat(Task5.isPalindrome(input)).isEqualTo(expected);
    }
    ...
    public void testSumAdjacentDigits(String input, String expected) {
        assertThat(Task5.calculateDescendant(input)).isEqualTo(expected);
    }
